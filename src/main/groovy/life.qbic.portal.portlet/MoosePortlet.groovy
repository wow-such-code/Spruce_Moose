...
/**
 * Entry point for portlet Spruce_Moose. This class derives from {@link QBiCPortletUI}, which is found in the {@code portal-utils-lib} library.
 *
...
@Log4j2
@CompileStatic
class MoosePortlet extends QBiCPortletUI {
